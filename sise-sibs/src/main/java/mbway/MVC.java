...
public class MVC {
	...
	public static void main(String[] args) throws MbwayException, BankException, ClientException, AccountException {
		...
		Client sourceClient = new Client(sourceBank, new ClientPersonalInfo(FIRST_NAME, LAST_NAME, NIF, 33),
				PHONE_NUMBER, ADDRESS);
		Client targetClient = new Client(targetBank, new ClientPersonalInfo(FIRST_NAME, LAST_NAME, NIF, 22),
				PHONE_NUMBER, ADDRESS);
